...
app.directive('ngSocialFacebook', function() {
    ...
    var options = {
        ...
        popup: {
            url: 'http://www.facebook.com/sharer/sharer.php?s=100&p[url]={url}&p[images][0]={image}&p[title]={title}&p[summary]={description}',
            width: 600,
            height: 500
        },
        track: {
...
app.directive('ngSocialTwitter', function() {
    ...
    var options = {
        ...
        popup: {
            url: 'http://twitter.com/intent/tweet?url={url}&text={title} - {image}',
            width: 600,
            height: 450
        },
